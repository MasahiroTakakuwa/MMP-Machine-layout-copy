    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <a class="layout-topbar-logo" routerLink="/">
                ...
                <img src="assets/logo.png" alt="Maruei Miyazaki Logo" class="h-10" />
                <!-- <span>SAKAI</span> -->
            </a>
        </div>
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                <button type="button" class="layout-topbar-action" (click)="displayFullScreen()">
                    <i ngClass='pi pi-expand'></i>
                </button>
...
export class AppTopbar {
    ...
    displayFullScreen() {
        ...
        if (this.isFullscreen) {
            ...
            const ele = document as Document & {
            ...
            if (ele.exitFullscreen) {
                ele.exitFullscreen();
            } else if (ele.mozCancelFullScreen) { /* Firefox */
                ele.mozCancelFullScreen();
            } else if (ele.webkitExitFullscreen) { /* Chrome, Safari and Opera */
                ele.webkitExitFullscreen();
            } else if (ele.msExitFullscreen) { /* IE/Edge */
